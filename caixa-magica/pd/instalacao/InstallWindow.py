...
class InstallWindow(Toplevel):
    ...
    def salvar_novos_valores(self):
        ...
        if len(veiculo) <= 0:
            ...
            if len(numero_instalacao) <= 0:
                messagebox.showwarning('Aviso', 'Código da instalação inválida!')
            else:
                self.destroy()
    ...
    def __init__(self, master=None):
        ...
        self.lbl_onibus = Label(self.frame_dados_onibus, text="Veículo: ", font=fonte)
